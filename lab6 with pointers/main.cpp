...
void sobel_442(int row_start, int row_end, int col_start, int col_end){
    ...
    p1p = &img_gray.at<uint8_t>(row_start-1,col_start-1);
    p2p = &img_gray.at<uint8_t>(row_start-1,col_start);
    p3p = &img_gray.at<uint8_t>(row_start-1,col_start+1);
    p4p = &img_gray.at<uint8_t>(row_start-1,col_start+1);
    p5p = &img_gray.at<uint8_t>(row_start,col_start);
    p6p = &img_gray.at<uint8_t>(row_start,col_start+1);
    p7p = &img_gray.at<uint8_t>(row_start+1,col_start-1);
    p8p = &img_gray.at<uint8_t>(row_start+1,col_start);
    p9p = &img_gray.at<uint8_t>(row_start+1,col_start+1);
